...
Vec4 VecAdd(const Vec4 a, const Vec4 b);
...
Vec4 VecScale(const Vec4 a, const float factor);
...
Mat4 LookTo(Vec4 eye, Vec4 direction, Vec4 up);
...
/// @param angle The angle of rotation in radians.
/// @returns The rotation matrix.
Mat4 RotNorm(Vec4 normaxis, float angle);
...
/// @param angle The angle of rotation in radians.
/// @returns The rotation matrix.
Mat4 RotAxis(Vec4 axis, float angle);
...
Vec4 VecSelect(Vec4 a, Vec4 b, Vec4 control);
...
inline Vec4 VecAdd(const Vec4 a, const Vec4 b)
{
   return _mm_add_ps(a, b);
}

inline Vec4 VecScale(const Vec4 a, const float factor)
{
...
inline Mat4 RotNorm(Vec4 normaxis, float angle)
{
   float fSinAngle;
   float fCosAngle;
...
inline Mat4 RotAxis(Vec4 axis, float angle)
{
...
inline Vec4 VecSelect(Vec4 a, Vec4 b, Vec4 control)
{
...
inline Vec4 VecTransf(Vec4 a, Mat4 b)
{
...
inline Vec4 VecMul(Vec4 a, Vec4 b)
{
   return _mm_mul_ps(a, b);
}

inline Vec4 VecRound(Vec4 a)
{
...
inline Vec4 VecSetX(Vec4 a, float x)
{
...
inline Vec4 VecSetY(Vec4 a, float y)
{
...
inline Vec4 VecSetZ(Vec4 a, float z)
{
...
inline Vec4 VecSetW(Vec4 a, float w)
{
